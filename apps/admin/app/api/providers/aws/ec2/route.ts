...
import { listAwsInstances, runAwsInstanceAction } from "@/lib/services/providers/aws";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Failed to execute AWS action";
    await writeAuditLog({
      userId: auth.user.id,
      action: "aws_action",
      provider: "aws",
